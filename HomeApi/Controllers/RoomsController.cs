...
namespace HomeApi.Controllers
{
    ...
    public class RoomsController : ControllerBase
    {
            ...
            [FromBody] EditRoomRequest request)
        {
            ...
            return StatusCode(200, $"Данные комнаты обновлены! Имя - {room.Name}, Площадь - {room.Area}, Наличие газоснабжения - {room.GasConnected}, Максимальное напряжение - {room.Voltage}");
        }
    }
}